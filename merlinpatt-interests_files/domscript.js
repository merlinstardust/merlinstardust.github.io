...
/*
     FILE ARCHIVED ON 2:10:20 Aug 4, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:18:25 Sep 28, 2015.
	...
	var domscripts = {
		...
		installStickyMenu: function installStickyMenu () {
			...
			if (nav.find('.ym-hlist').length > 0 ) {
				...
				var menu =	'<li id="smnav"><label for="ym-smnav" style="padding: 0 0.5em; color: rgba(255,255,255,.8)">Navigation:</label> '+
...
/*
			$('.jquery_tabs2:not([data-sync])').accessibleTabs({
				fx:"show",
				fxspeed: '',
				syncheights: false,
				tabhead: 'h5',
