...
/*
     FILE ARCHIVED ON 13:10:36 Dec 21, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:18:23 Sep 28, 2015.
 ...
 *
 * english article: /web/20141221131036/http://blog.ginader.de/archives/2009/02/07/jQuery-Accessible-Tabs-How-to-make-tabs-REALLY-accessible.php
 * german article: /web/20141221131036/http://blog.ginader.de/archives/2009/02/07/jQuery-Accessible-Tabs-Wie-man-Tabs-WIRKLICH-zugaenglich-macht.php
 *
 * code: /web/20141221131036/http://github.com/ginader/Accessible-Tabs
 * please report issues at: /web/20141221131036/http://github.com/ginader/Accessible-Tabs/issues
 *
 * Copyright (c) 2007 Dirk Ginader (ginader.de)
 * Dual licensed under the MIT and GPL licenses:
 * /web/20141221131036/http://www.opensource.org/licenses/mit-license.php
 * /web/20141221131036/http://www.gnu.org/licenses/gpl.html
 *
 * Version: 1.9.4
 *
 * History:
 ...
 * *   is available /web/20141221131036/http://blog.ginader.de/dev/jquery/syncheight/index.php
 ...
 * * * new option "syncHeightMethodName" fixed issue: /web/20141221131036/http://github.com/ginader/Accessible-Tabs/issues/2/find
 * * * new Method showAccessibleTab({index number of the tab to show starting with 0})  fixed issue: /web/20141221131036/http://github.com/ginader/Accessible-Tabs/issues/3/find
 * * * added support for the Cursor Keys to come closer to the WAI ARIA Tab Panel Best Practices /web/20141221131036/http://github.com/ginader/Accessible-Tabs/issues/1/find
 * * 1.6
 * * * new option "saveState" to allow tabs remember their selected state using cookies requires the cookie plugin: /web/20141221131036/http://plugins.jquery.com/project/Cookie
 ...
 * * 1.8.2
 * * * Bugfix for issue described by Sunshine here: /web/20141221131036/http://blog.ginader.de/archives/2009/02/07/jQuery-Accessible-Tabs-How-to-make-tabs-REALLY-accessible.php#c916
 * * 1.8.3
 ...
 * * * by jQuery Selector instead of the index in showAccessibleTab() fixing issue /web/20141221131036/https://github.com/ginader/Accessible-Tabs/issues/15
 ...
 * * * This commit fixes this assumption, as I only want classes on some elements /web/20141221131036/https://github.com/ginader/Accessible-Tabs/pull/25
 * * 1.9.4 Bugfix by Patrick Bruckner to fix issue with Internet Explorer using jQuery 1.7 /web/20141221131036/https://github.com/ginader/Accessible-Tabs/issues/26
 */
    ...
    $.fn.extend({
        ...
        accessibleTabs: function(config) {
            var defaults = {
                ...
                syncheights:false, // syncs the heights of the tab contents when the SyncHeight plugin is available /web/20141221131036/http://blog.ginader.de/dev/jquery/syncheight/index.php
                syncHeightMethodName:'syncHeight', // set the Method name of the plugin you want to use to sync the tab contents. Defaults to the SyncHeight plugin: /web/20141221131036/http://github.com/ginader/syncHeight
                cssClassAvailable:false, // Enable individual css classes for tabs. Gets the appropriate class name of a tabhead element and apply it to the tab list element. Boolean value
                saveState:false, // save the selected tab into a cookie so it stays selected after a reload. This requires that the wrapping div needs to have an ID (so we know which tab we're saving)
                autoAnchor:false, // will move over any existing id of a headline in tabs markup so it can be linked to it
                pagination:false, // adds buttons to each tab to switch to the next/previous tab
                position:'top', // can be 'top' or 'bottom'. Defines where the tabs list is inserted.
                wrapInnerNavLinks: '', // inner wrap for a-tags in tab navigation. See /web/20141221131036/http://api.jquery.com/wrapInner/ for further informations
